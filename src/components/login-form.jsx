...
function loginGoogle(res){
  ...
  return (
    <div className={cn("flex flex-col gap-6 w-full max-w-[890px] h-auto md:h-[800px] justify-center px-4", className)}{...props}>
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                ...
                <Input id="email" type="email" placeholder="m@example.com" required focus={"1"} onChange={(e)=>{setEmail(e.target.value)}}/>
              </div>
              ...
              <div
                ...
                <span className="bg-card text-muted-foreground relative z-10 px-2">
                  Or continue with
                    ...
                    <GoogleLogin onSuccess={(res)=>loginGoogle(res)} variant="outline" type="button" className="w-full"/>
